...
#define LOG_FILE "afl_frontier_log.txt"
...
struct queue_entry {
  ...
  u8 colorized,                         /* Do not run redqueen stage again  */
      ...
      set_favored,                      /* Set Cover favored flag           */
      set_covered;                      /* Set Cover choosed          */
...
typedef struct afl_state {
  ...
  u8 havoc_stack_pow2,                  /* HAVOC_STACK_POW2                 */
      ...
      use_set_cover_scheduling;     /* use set cover seed selection   */
...
#define N_FUZZ_SIZE (1 << 21)
  ...
  u32 cull_queue_new_call_nums;
  u32 detect_frontier_changes_nums;
  u32 use_previou_call_and_random;
...
bool is_frontier_node_outer(afl_state_t *afl, u32 id);
...
void load_cfg(afl_state_t *afl); //加载CFG
void get_cfg_path(afl_state_t *afl); //获取CFG路径
