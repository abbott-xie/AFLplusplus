...
def parse_args():
    ...
    parser.add_argument("--ztaint_target_binary", type=str, required=True, help="Path to the ZTaint-instrumented target binary, if not provided, will be set to [target_binary]_ztaint")
