...
class ModuleSanitizerCoverageAFL
 ...
 private:
  ...
  bool InjectCoverage(Function &F, ArrayRef<BasicBlock *> AllBlocks, DenseMap<Instruction *, size_t> &SancovMapIndex, DenseMap<BasicBlock *, size_t> &BBMapIndex, bool IsLeafFunc = true);
